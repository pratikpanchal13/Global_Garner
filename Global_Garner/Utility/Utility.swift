...
class Utility: NSObject ,UIPickerViewDelegate,UIPickerViewDataSource, UIImagePickerControllerDelegate,UINavigationControllerDelegate, UIActionSheetDelegate {
    ...
    func animateCells(tableView: UITableView) {
        ...
        for a in cells {
            ...
            UIView.animate(withDuration: 1.5, delay: 0.10 * Double(index),usingSpringWithDamping: 0.8, initialSpringVelocity: 0.7, options: .curveEaseOut, animations: {
...
//    func animateTable(aTable : UITableView) {
//        
//        let cells = aTable.visibleCells
//        let tableHeight: CGFloat = aTable.bounds.size.height
//        
//        for i in cells {
//            let cell: UITableViewCell = i as UITableViewCell
//            cell.transform = CGAffineTransform(translationX: 0, y: tableHeight)
